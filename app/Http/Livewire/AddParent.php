...
use Livewire\WithFileUploads;                //    to use upload file  wuth Livewire

class AddParent extends Component
{
    use WithFileUploads;

    public $successMessage = '';            //   message after add

    public $catchError, $updateMode = false , $photos , $show_table = true , $Parent_id;

    public $currentStep = 1,               // choose who page show

        // wire:model == Father_Inputs in blade
        $Email , $Password ,
        ...
        // wire:model ==  Mother_Inputs in blade
    ...
    public function render() {               // like index in controller have all info

        return view('livewire.add-parent', [
            'Nationalities'     => Nationalitie::get(),
            'Type_Bloods'       => Type_Blood::get(),
            'Religions'         => Religion::get(),
            'my_parents'        => My_Parent::get(),
        ]);
    }
    ...
    public function updated($propertyName) {
        ...
        // firstStepSubmit   to go to next page after check validation
    public function firstStepSubmit() {
     ...
     //    go to step 3 after make validation
    public function secondStepSubmit() {
            $this->validate([                // vlidate mother
    ...
    // store data in dataase
    public function submitForm()  {
        try
        {
            $My_Parent = new My_Parent();
            // Father_INPUTS
            $My_Parent->Email                   = $this->Email;          // $this = request->email
            ...
            // Add Attachment my_parents
            if ( !empty($this->photos) ) {

                foreach ($this->photos as $photo) {
                    $photo->storeAs( $this->Name_Father,
                      $photo->getClientOriginalName(), $disk = 'parent_attachments');
            ...
            $this->clearForm();
            $this->currentStep = 1;                     // after add  return page 1 [ Form Father ]
        ...
        //   back page  before page
    public function back($step)
    {
        $this->currentStep = $step;
    }

    public function showformadd()     // To show table  not show Form
    {
        $this->show_table = false;
    }

    public function edit($id) {
        $this->show_table       = false;    //  hidden table
        $this->updateMode       = true;     //  now use Edit
    ...
    //firstStepSubmit  To Edit data father
    ...
    //  secondStepSubmit_edit   To Edit data Mother
    ...
    public function submitForm_edit()       //  to save data after update
    {
        if ($this->Parent_id)
        {
            ...
            $parent->update([
                'Email'                     => $this->Email ,
                // 'Password'                  => Hash::make( $this->Password ) ,  //  not work
    ...
    // clear Form  After Add O peration
