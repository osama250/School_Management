...
class ParentsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('my_parents')->delete();
            ...
            $my_parents->email                  = 'osamayosry@yahoo.com';
            $my_parents->password               = Hash::make('12345678');
            $my_parents->Name_Father            = ['en' => 'osama yousry', 'ar' => 'اسامة يسرى'];
            $my_parents->National_ID_Father     = '1234567810';
            $my_parents->Passport_ID_Father     = '1234567810';
            $my_parents->Phone_Father           = '01092607753';
            ...
            $my_parents->Phone_Mother           = '01092607753';
